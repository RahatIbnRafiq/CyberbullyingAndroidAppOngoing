...
import com.example.cybersafetyapp.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        mAuthUrl = AUTH_URL + "?client_id=" + clientId + "&redirect_uri="
                + mCallbackUrl + "&response_type=code&display=touch&scope=likes+comments+relationships+public_content";
    ...
    private void getAccessToken(final String code) {
        ...
        new Thread() {
            @Override
            public void run() {
                Log.i(UtilityVariables.tag, "Getting access token");
    ...
    private void fetchUserName() {
        ...
        new Thread() {
            @Override
            public void run() {
                Log.i(UtilityVariables.tag, "Fetching user info");
                int what = WHAT_FINALIZE;
                try {
                    URL url = new URL(API_URL + "/users/" + mSession.getId() + "/?access_token=" + mAccessToken);

                    Log.d(UtilityVariables.tag, "Opening URL " + url.toString());
                    HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                    ...
                    Log.i(UtilityVariables.tag, "Got name: " + name + ", bio [" + bio + "]");
                } catch (Exception ex) {
                    what = WHAT_ERROR;
                    ex.printStackTrace();
                }
