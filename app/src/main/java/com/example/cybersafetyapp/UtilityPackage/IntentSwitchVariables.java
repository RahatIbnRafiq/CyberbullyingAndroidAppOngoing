...
public class IntentSwitchVariables {
    public static final String TO_BE_MONITORED_USERIDS = "toBeMonitoredUserIds";
    ...
    public static final String FEEDBACK_COMMENT_LIST = "fedbackCommentList";
    ...
    public static final String OSN_NAME = "OSNName";
    public static final String INSTAGRAM = "Instagram";


    public static final String INSTAGRAM_LOGIN_CODE = "InstagramLoginCode";
